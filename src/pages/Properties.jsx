...
function Properties() {
  ...
  // ✅ For BUY toggle
  const [selectedCategory, setSelectedCategory] = useState("FULL_HOUSE");
  ...
  useEffect(() => {
    ...
    setError("");
    axios
      .get("http://localhost:8080/api/search/advanced", {
        params: {
          city: city || null,
  ...
  }, [city, bhk, propertyType, listingType, furnishing, parking]);
